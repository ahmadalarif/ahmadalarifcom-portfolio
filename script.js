document.addEventListener("DOMContentLoaded", () => {
  ...
  const textContent = {
      ...
      projects: [
        {
          ...
          description: "A classic Connect Four implementation with modern UI/UX features. Built with vanilla JavaScript, HTML5, and CSS3 with responsive design principles.",
          link: "https://ahmadalarif.github.io/connect4/"
        },
        {
          title: "GYM Management System (Frontend)",
          description: "Member-facing interface for class registration and booking system. Features real-time availability updates and calendar integration. Developed with PHP and MySQL.",
          link: "https://maigrop.com/almacenters/"
        },
        {
          title: "GYM Management System (Backend)",
          description: "Admin dashboard with class scheduling, attendance tracking, and waitlist management. Secure authentication system with role-based access control.",
          link: "https://maigrop.com/almacenters/"
        },
        {
          title: "Online Food Ordering System",
          description: "Full-stack food ordering platform with menu customization and order tracking. Built with Gatsby (React) frontend and Contentful CMS backend.",
          link: "https://awesome-varahamihira-16b9b2.netlify.app/"
        },
        {
          title: "Finance Company Portal",
          description: "Secure client portal for financial services company with document management features. Built with Ruby on Rails and deployed on Render.",
          link: "https://alraedah.sa/en/"
        },
        {
          title: "React Calculator App",
          description: "Interactive calculator application demonstrating React state management and component architecture.",
    ...
    ar: {
      name: "أحمد عارف",
      title: "مهندس برمجيات || مطور ويب مستقل",
      aboutme: "نبذة عني",
      about: "مرحبًا بكم في موقعي الشخصي! كمطور ويب كامل الشمول ذو خبرة، أتخصص في إنشاء تطبيقات الويب التفاعلية الجذابة. أمتلك مهارات متقدمة في HTML وCSS وJavaScript وReact وRuby وRuby On Rails وNode.js وExpress.js وMongoDB، مما يمكنني من التعامل مع المشاريع المعقدة. أزدهر في البيئات الصعبة وأتعاون مع العملاء والمطورين لإنشاء حلول ويب استثنائية. يركز نهجي على المستخدم النهائي لضمان سهولة الاستخدام والجاذبية البصرية والأداء الممتاز على جميع الأجهزة. مع مهارات اتصال قوية والتزام بتسليم النتائج في الوقت المحدد، أبقى دائمًا على اطلاع بأحدث التقنيات. سواء كنت بحاجة إلى موقع ويب بسيط أو تطبيق ويب متكامل، فأنا أمتلك المهارات اللازمة لتحقيق متطلباتك. لا تتردد في التواصل إذا كنت مهتمًا بالعمل معًا!",
      projectsTitle: "المشاريع",
      projects: [
        {
          title: "المشروع الأول: لعبة توصيل أربعة",
          description: "تنفيذ حديث للعبة Connect Four الكلاسيكية بواجهة مستخدم متطورة. تم البناء باستخدام JavaScript وHTML5 وCSS3 بتصميم سريع الاستجابة.",
          link: "https://ahmadalarif.github.io/connect4/"
        },
        {
          title: "نظام إدارة النوادي الرياضية (الواجهة الأمامية)",
          description: "واجهة المستخدم لنظام حجز الفصول الرياضية مع تحديثات الوقت الحقيقي وتكامل التقويم. تم التطوير باستخدام PHP وMySQL.",
          link: "https://maigrop.com/almacenters/"
        },
        {
          title: "نظام إدارة النوادي الرياضية (الواجهة الخلفية)",
          description: "لوحة تحكم إدارية مع جدولة الفصول وتتبع الحضور وإدارة قوائم الانتظار. نظام مصادقة آمن مع صلاحيات مستندة على الأدوار.",
          link: "https://maigrop.com/almacenters/"
        },
        {
          title: "نظام طلب الطعام الإلكتروني",
          description: "منصة كاملة لإدارة طلبات الطعام مع تتبع الطلبات. تم البناء باستخدام Gatsby (React) للواجهة الأمامية وContentful لإدارة المحتوى.",
          link: "https://awesome-varahamihira-16b9b2.netlify.app/"
        },
        {
          title: "بوابة شركة التمويل",
          description: "بوابة عملاء آمنة لشركة خدمات مالية مع إدارة المستندات. تم البناء باستخدام Ruby on Rails والنشر على Render.",
          link: "https://alraedah.sa/en/"
        },
        {
          title: "تطبيق آلة حاسبة",
          description: "آلة حاسبة تفاعلية توضح إدارة الحالة وهندسة المكونات في ريأكت.",
          link: "https://reactcalculatorapp1.netlify.app/"
        }
      ],
