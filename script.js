document.addEventListener("DOMContentLoaded", () => {
  ...
  const textContent = {
    en: {
      ...
      projects: [
        ...
        {
          title:
            "Project Two (FrontEnd): GYM Members registration and booking Page",
          description:
            "The objective of this system is to provide a convenient and efficient way for gym members to reserve spots in fitness classes offered at the gym. This system is enable members to easily browse through available classes and schedules, and make reservations for the classes they wish to attend. built with PHP",
          link: "https://maigrop.com/almacenters/",
        },
        {
          title: "Project Two (BackEnd): GYM Admin dashboard",
          description:
            "The gym class booking system  allow gym administrators to manage class schedules, set class capacities, and track attendance. This system is providing real-time updates on class availability and allow for automated waitlist management. built with cpanel (User Name: admin,  Password: admin)",
          link: "https://maigrop.com/almacenters/",
        },
        {
          title: "Project Three: Online Food & Beverage Menu",
          description:
            "The objective of this online food menu is to provide a user-friendly platform for customers to browse through available food options and place orders for delivery, takeout, or dine-in at a restaurant. The online food menu is offering an easy-to-use interface that is accessible through multiple devices, including desktop computers, tablets, and smartphones. built with Gatsby for frontend and Contentful for the backend",
  ...
  function setLanguage(lang) {
    ...
    document.getElementById("projects-title").textContent =
      textContent[lang].projectsTitle;
    document.getElementById("contact-title").textContent =
      textContent[lang].contactTitle;
    ...
    document.querySelector('label[for="contact-name"]').textContent =
      textContent[lang].contact.name;
    document.querySelector('label[for="contact-email"]').textContent =
      textContent[lang].contact.email;
    document.querySelector('label[for="contact-message"]').textContent =
      textContent[lang].contact.message;
    document.getElementById("contact-submit").textContent =
      textContent[lang].contact.send;
